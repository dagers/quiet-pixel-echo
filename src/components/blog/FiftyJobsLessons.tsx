...
export const FiftyJobsLessons = ({ onBack }: BlogPostProps) => {
  const handleLinkedInShare = () => {
    ...
    const title = encodeURIComponent("What I Learned from Having 50+ Jobs: Dreams vs. Employment");
    const summary = encodeURIComponent("A journey through the employment landscape and the unwavering belief in personal dreams and entrepreneurial spirit.");
