...
export const PremierLeagueStartup = ({ onBack }: BlogPostProps) => {
  const handleLinkedInShare = () => {
    ...
    const title = encodeURIComponent("A Crazy Google Search That Led to a Premier League Startup");
    const summary = encodeURIComponent("How one Google search led to BBC features, Premier League partnerships, and six-figure funding rounds.");
