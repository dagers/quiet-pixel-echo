...
import { ArrowLeft, Globe, Heart, Compass, Users, TrendingUp, Linkedin } from "lucide-react";
...
export const HomeWhereTheHeartIs = ({ onBack }: BlogPostProps) => {
  const handleLinkedInShare = () => {
    ...
    const title = encodeURIComponent("If home's where the heart is then i'll wear it on my sleeve");
    const summary = encodeURIComponent("Exploring identity and purpose as a global citizen in search of belonging and meaning.");
